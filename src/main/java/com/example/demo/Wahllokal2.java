...
public class Wahllokal2 {
    ...
    private final String regionID = "station-002"; // ID für die Message Queue
    ...
    public void sendElectionData() {
        try {
            ...
            System.out.println("2 -> Data sent to queue: " + message);
            Log logger = new Log("Lokal-002.txt");
            logger.appendString("2 -> Data sent to queue: " + message);
